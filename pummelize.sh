...
#  vcodec=mpeg4:vhq:trell:mbd=2:vmax_b_frames=1:v4mv:vb_strategy=0:o=luma_elim_threshold==0:o=chroma_elim_threshold==0:cmp=6:subcmp=6:precmp=6:predia=3:dia=3:vme=4:vqscale=1 \
...
Please use o=luma_elim_threshold=<value> instead of vlelim.
